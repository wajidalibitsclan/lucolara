            ...
            <li>
                <div class="timeline timeline_small uk-margin-bottom">
                    ...
                    <div class="timeline_item">
                        ...
                        <div class="timeline_content">Deleted post <a href="#"><strong>Qui quas occaecati eveniet nulla voluptatem.</strong></a></div>
                    </div>
                    <div class="timeline_item">
                    ...
                    <div class="timeline_item">
                        ...
                        <div class="timeline_content">
                            New comment on post <a href="#"><strong>Nam accusantium vel ut.</strong></a>
                            <div class="timeline_content_addon">
                                <blockquote>
                                    Nostrum voluptatum ipsum quas aut placeat praesentium est.&hellip;
                                </blockquote>
                            </div>
                        </div>
                    </div>
                                ...
                                <ul class="md-list md-list-addon">
                                    <li>
                                        ...
                                        <div class="md-list-content">
                                            <span class="md-list-heading">Karlie Shanahan</span>
                                            <span class="uk-text-small uk-text-muted">Ratione et consequatur fuga.</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                ...
                <ul class="md-list md-list-addon chat_users">
                    <li>
                        ...
                        <div class="md-list-content">
                            ...
                            <span class="md-list-heading">Trinity Jaskolski</span>
                            <span class="uk-text-small uk-text-muted uk-text-truncate">Quidem sunt veritatis.</span>
                        </div>
                    </li>
                    <li>
                        <div class="md-list-addon-element">
                        ...
                        <div class="md-list-content">
                            <div class="md-list-action-placeholder"></div>
                            <span class="md-list-heading">Luella Hyatt</span>
                            <span class="uk-text-small uk-text-muted uk-text-truncate">Enim harum omnis.</span>
                        </div>
                    </li>
                    <li>
                        <div class="md-list-addon-element">
                        ...
                        <div class="md-list-content">
                            <div class="md-list-action-placeholder"></div>
                            <span class="md-list-heading">Rachelle Hauck</span>
                            <span class="uk-text-small uk-text-muted uk-text-truncate">Corrupti earum.</span>
                        </div>
                    </li>
                    <li>
                        <div class="md-list-addon-element">
                        ...
                        <div class="md-list-content">
                            <div class="md-list-action-placeholder"></div>
                            <span class="md-list-heading">Brooke Leffler</span>
                            <span class="uk-text-small uk-text-muted uk-text-truncate">Est exercitationem.</span>
                        </div>
                    </li>
                </ul>
