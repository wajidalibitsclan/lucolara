    ...
    <div class="sidebar_main_header">
        <div class="sidebar_logo" style="height: 100%">
            <a href="{{ route('home') }}" class="sSidebar_hide sidebar_logo_large">
                <img class="logo_regular" src="{{ asset('assets/img/logo.svg') }}" alt="" height="71"
                    width="71" />
                <img class="logo_light" src="{{ asset('assets/img/logo.svg') }}" alt="" height="71"
                    width="71" />
            </a>
            <a href="{{ route('home') }}" class="sSidebar_show sidebar_logo_small">
                <img class="logo_regular" src="{{ asset('assets/img/logo.svg') }}" alt="" height="32"
                    width="32" />
                <img class="logo_light" src="{{ asset('assets/img/logo.svg') }}" alt="" height="32"
                    width="32" />
            </a>
        </div>
    </div>
    ...
    <div class="menu_section">
        <ul>
            ...
            <li title="Teatro">
                ...
                <ul>
                    <li><a href="{{ route('adminList', ['object' => 'lucaronconi1933_2015']) }}">Visualizza articoli</a>
                    </li>
