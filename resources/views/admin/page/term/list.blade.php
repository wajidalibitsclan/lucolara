            ...
            <div class="md-card uk-margin-medium-bottom">
                <div class="md-card-content">
                    <div class="uk-width-medium-1-1">
                        <a class="md-btn md-btn-primary md-btn-wave-light md-btn-icon waves-effect waves-button waves-light"
                            href="{{ route('creaTermine', ['objectid' => $termini->vocabolario->id]) }}">
            ...
            <div class="md-card uk-margin-medium-bottom">
                <div class="md-card-content">
                    <div class="uk-width-large-1-1 uk-width-medium-1-2">
                        <form action="{{ route('listaTermini', ['objectid' => $termini->vocabolario->id]) }}"
                            method="get">
                                ...
                                @foreach ($termini as $termine)
                                    <tr id="{{ $termine->id }}">
                                        ...
                                        <td class="uk-text-center">
                                            <a
                                                href="{{ route('editTermine', ['objectid' => $termini->vocabolario->id, 'termid' => $termine->id]) }}"><i
                                                    class="md-icon material-icons"></i></a>
                                        </td>
                                        <td class="uk-text-center">
                                            <a href="#" class="delete_article" data-id="{{ $termine->id }}"><i
                                                    class="md-icon material-icons">&#xE872;</i></a>
                                        </td>
                                    </tr>
                                @endforeach
