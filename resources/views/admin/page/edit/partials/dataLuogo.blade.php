            ...
            <div class="uk-grid">
                ...
                <div class="uk-width-medium-1-1 uk-row-first">
                    ...
                    <div class="md-input-wrapper">
                        ...
                        <input type="text" class="md-input" name="teatro" value="{{ $result->teatro }}"><span
                            class="md-input-bar "></span>
                    </div>
                    <div class="md-input-wrapper">
                        <h3 class="heading_c">Città</h3>
                        <input type="text" class="md-input" name="citta" value="{{ $result->citta }}"><span
                            class="md-input-bar "></span>
                    </div>
                    <div class="md-input-wrapper">
                        ...
                        <div class="uk-input-group">
                            ...
                            @endphp
                            <input class="md-input" type="text" name="data_di_pubblicazione" id="uk_dp_1"
                                value="{{ $data_di_pubblicazione }}" data-uk-datepicker="{format:'DD/MM/YYYY'}">
                        </div>
                    </div>
                </div>
            </div>
