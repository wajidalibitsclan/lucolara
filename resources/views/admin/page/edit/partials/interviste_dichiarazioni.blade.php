                                    ...
                                    <div class="uk-width-medium-1-1 uk-row-first">
                                        ...
                                        <div class="uk-form-row">
                                            <div class="md-input-wrapper md-input-filled">
                                                ...
                                                <input type="text" name="titolo_intervista" class="md-input"
                                                    value="{{ $intervista['titolo_intervista'] }}"><span
                                                    class="md-input-bar "></span>
                                            </div>
                                        </div>
                                                    ...
                                                    @foreach ($intervista['domanda_risposta'] as $domanda_risposta)
                                                        <div class="uk-form-row" data-repeater-item>
                                                            <div class="md-input-wrapper md-input-filled">
                                                                ...
                                                                <textarea id="descrizione_media" cols="30" rows="4" class="md-input selecize_init" name="domanda_intervista">{{ $domanda_risposta['domanda_intervista'] }}</textarea><span
                                                                    class="md-input-bar "></span>
                                                            </div>
                                                            <div class="md-input-wrapper md-input-filled">
                                                                <label>Risposta Intervista</label>
                                                                <textarea id="descrizione_media" cols="30" rows="4" class="md-input selecize_init"
                                                                    name="risopsta_intervista">{{ $domanda_risposta['risopsta_intervista'] }}</textarea><span
                                                                    class="md-input-bar "></span>
                                                            </div>
                                                ...
                                                @else
                                                    <div class="uk-form-row" data-repeater-item>
                                                        <div class="md-input-wrapper md-input-filled">
                                                            <label>Domanda Intervista</label>
                                                            <textarea id="descrizione_media" cols="30" rows="4" class="md-input selecize_init"
                                                                name="domanda_intervista"></textarea><span
                                                                class="md-input-bar "></span>
                                                        </div>
                                                        <div class="md-input-wrapper md-input-filled">
                                                            <label>Risposta Intervista</label>
                                                            <textarea id="descrizione_media" cols="30" rows="4" class="md-input selecize_init"
                                                                name="risopsta_intervista"></textarea><span
                                                                class="md-input-bar "></span>
                                                        </div>
                                                        <input data-repeater-delete type="button"
                                                            class="md-btn md-btn-danger" value="Elimina" />
                            ...
                            <div class="uk-nestable-panel">
                                ...
                                <div class="uk-width-medium-1-1 uk-row-first">
                                    ...
                                    <div class="uk-form-row">
                                        <div class="md-input-wrapper md-input-filled">
                                            <label>Titolo Intervista</label>
                                            <input type="text" name="titolo_intervista" class="md-input"><span
                                                class="md-input-bar "></span>
                                        </div>
                                    </div>
                                        ...
                                        <div data-repeater-list="domanda_risposta">
                                            <div class="uk-form-row" data-repeater-item>
                                                <div class="md-input-wrapper md-input-filled">
                                                    <label>Domanda Intervista</label>
                                                    <textarea id="descrizione_media" cols="30" rows="4" class="md-input selecize_init"
                                                        name="domanda_intervista"></textarea><span class="md-input-bar "></span>
                                                </div>
                                                <div class="md-input-wrapper md-input-filled">
                                                    <label>Risposta Intervista</label>
                                                    <textarea id="descrizione_media" cols="30" rows="4" class="md-input selecize_init"
                                                        name="risopsta_intervista"></textarea><span class="md-input-bar "></span>
                                                </div>
                                                <input data-repeater-delete type="button"
                                                    class="md-btn md-btn-danger" value="Elimina" />
                                            </div>
