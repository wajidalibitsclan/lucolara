...
@section('main-content')
    ...
    <div id="page_content">
        <div id="page_content_inner">
            <form method="post" action="{{ route('adminUpdate', ['object' => $result->type, 'id' => $result->id]) }}"
                                        ...
                                        <div class="uk-width-medium-1-1 uk-row-first">
                                            <div class="md-input-wrapper">
                                                ...
                                                <input type="text" class="md-input" name="title"
                                                    value="{{ $result->title }}"><span class="md-input-bar "></span>
                                            </div>
                                            <div class="md-input-wrapper">
                                            ...
                                            <div class="md-input-wrapper">
                                                ...
                                                <input type="text" class="md-input" name="sotto_titolo"
                                                    value="{{ $result->sotto_titolo }}"><span class="md-input-bar "></span>
                                            </div>
                                            <div class="md-input-wrapper">
                                                <h3 class="heading_c">Riassunto</h3>
                                                <textarea name="riassunto" cols="30" rows="4" class="md-input">{{ $result->riassunto }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="uk-grid">
                                        <div class="uk-width-medium-1-1 uk-row-first">
                                            <div class="md-input-wrapper">
                                                ...
                                                <textarea id="wysiwyg_ckeditor" name="body" cols="30" rows="20">{{ $result->body }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="md-card">
                            <div class="md-card-content">
                                ...
                                <div id="dragula_sortable"
                                    class="uk-grid uk-grid-width-small-1-2 uk-grid-width-medium-1-3 uk-grid-width-large-1-5"
                                    data-uk-grid-margin>
                                    ...
                                    @if (isset($result->gallery) && !empty($result->gallery))
                                        @foreach ($result->gallery as $media_gallery_object)
                                            @if ($media_gallery_object->classSlug == 'photo')
                                                @include(
                                                    'admin.page.edit.partials.galleryPhoto',
                                                    $media_gallery_object)
                                            @elseif($media_gallery_object->classSlug == 'link')
                                                @include(
                                                    'admin.page.edit.partials.galleryVideo',
                                                    $media_gallery_object)
                                            @endif
                                        @endforeach
                                    @endif
                            ...
                            <div class="md-fab-wrapper md-fab-in-card">
                                <a id="add_media"
                                    class="md-fab md-fab-success md-fab-wave-light waves-effect waves-button waves-light"
                                    href="javascript:void(0)"><i class="material-icons md-color-white"></i></a>
                            </div>
                        </div>
                                ...
                                <div class="md-card" data-uk-grid-margin>
                                    <div class="md-card-content">
                                        ...
                                        <ul id="tabs_anim1" class="uk-switcher uk-margin">
                                            <li>@include(
                                                'admin.page.edit.partials.interviste_dichiarazioni',
                                                $result)</li>
                    ...
                    <div class="uk-width-medium-1-4">
                        <div id="immagine_in_evidenza">
                            @if ($result->hasImmagineInevidenza())
                                <div class="uk-width-medium-1-1">
                                    <button class="md-btn uk-width-medium-1-1" data-uk-modal="{target:'#modal_crop'}"
                                        onclick="event.preventDefault();">Modifica Il taglio immagine</button>
                                </div>
                                <img id="immagine_in_evidenza_src" src="{{ $result->getImmagineInEvidenza('450x9999') }}">
                                <input type="hidden" id="immagine_in_evidenza_id" name="immagine_in_evidenza_id"
                                    value="{{ $result->immagine_in_evidenza }}">
                            @endif
                        </div>
                        <div class="uk-grid" data-uk-grid-margin>
                            <div class="uk-width-medium-1-1">
                                ...
                                <div class="uk-grid" data-uk-grid-margin="">
                                    <div class="uk-width-medium-1-1">
                                        <h3 class="text-uppercase">
                                            @if ($result->object == 'lucaronconi1933_2015' || array_key_exists($result->category, luca_1933_submenus()))
                                                Luca Ronconi 1933-2015
                                            @elseif($result->object == 'dopo_lucaronconi' || array_key_exists($result->category, dopo_submenus()))
                                                Dopo Luca Ronconi
                                            @elseif($result->object == 'santacristina' || array_key_exists($result->object, santacristina_submenus()))
                                                Santacristina
                                ...
                                <div class="uk-grid" data-uk-grid-margin="">
                                    <div class="uk-width-medium-1-1">
                                        <input type="checkbox" data-switchery data-switchery-size="large"
                                            @if ($result->status == '1') checked @endif id="switch_demo_large"
                                            name="status" />
                                        <label for="switch_demo_large" class="inline-label">Pubblicato</label>
                                        <span class="uk-form-help-block">Se il pallino è verde l'articolo è
                                            pubblicato</span>
                                    </div>
                                    <div class="uk-width-medium-1-1">
        ...
        <div class="uk-modal-dialog  uk-modal-dialog-large">
            ...
            <div class="uk-overflow-container" style="">
                ...
                <div class="jc_coords uk-width-medium-1-1">
                    <form id="cropLocandina"
                        action="{{ route('ajaxLocandina', ['id' => $result->immagine_in_evidenza]) }}" method="post"
                        onsubmit="event.preventDefault(); return checkCoords();">
                        {{ csrf_field() }}
                        <input type="hidden" id="x" name="x" />
                        <input type="hidden" id="y" name="y" />
                        <input type="hidden" id="w" name="w" />
                        <input type="hidden" id="h" name="h" />
                        <input type="submit" class="md-btn md-btn-success uk-width-medium-1-1"
                            value="Ritalgia Immagine" />
                    </form>
                </div>
            </div>
                    ...
                    <div class="md-card uk-margin-large-bottom">
                        <div class="md-card-content">
                            <form class="uk-form-stacked" id="addMediaForm" enctype="multipart/form-data">
                                ...
                                <div class="md-input-wrapper">
                                    <h3 class="heading_c">Titolo</h3>
                                    <input id="title_media" type="text" class="md-input" name="title_media"
                                        value=""><span class="md-input-bar "></span>
                                </div>
                                <div class="md-input-wrapper md-input-filled">
                                    <h3 class="heading_c">Descrizione</h3>
                                    <textarea id="descrizione_media" cols="30" rows="4" class="md-input selecize_init"
                                        name="descrizione_media"></textarea><span class="md-input-bar "></span>
                                </div>
                                <div class="md-input-wrapper">
                                ...
                                <div id="link_media" class="md-input-wrapper md-input-filled" style="display: none;">
                                    ...
                                    <input type="text" class="md-input" name="link_media" value=""><span
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.rimuovi_documento').click(function(event) {
                ...
                UIkit.modal.alert(
                    "Ricordati di sostiuire il documento altrimenti verrà elimianta la riga!");
                $(this).parent().remove();
            })
