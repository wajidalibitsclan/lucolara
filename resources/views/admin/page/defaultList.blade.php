                            ...
                            <tbody>
                                @foreach ($results as $article)
                                    <tr id="{{ $article->id }}">
                                        <td class="uk-text-center">
                                            @if ($article->hasImmagineInEvidenza())
                                                <img class="md-user-image"
                                                    src="{{ $article->getImmagineInEvidenza('34x34') }}" alt="">
                                            @endif
                                        </td>
                                        <td>{{ $article->title }}</td>
                                        <td class="uk-text-center">
                                        ...
                                        <td class="uk-text-center">
                                            <a
                                                href="{{ route('adminEdit', ['object' => $article->type, 'id' => $article->id]) }}"><i
                                                    class="md-icon material-icons"></i></a>
                                        </td>
                                        <td class="uk-text-center">
                                            <a href="#" class="delete_article" data-id="{{ $article->id }}"><i
                                                    class="md-icon material-icons">&#xE872;</i></a>
                                        </td>
                                        <td class="uk-text-center">
                                            <a href="{{ $article->getPermalink() }}"><i
                                                    class="md-icon material-icons">&#xE417;</i></a>
                                        </td>
                                    </tr>
                                @endforeach
