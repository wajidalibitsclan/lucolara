                ...
                <div class="md-card-content">
                    <div class="uk-overflow-container">
                        <table class="uk-table uk-table-nowrap table_check">
                            ...
                            <tr>
                                <td class="uk-text-center uk-table-middle small_col"><div class="icheckbox_md"><input type="checkbox" data-md-icheck="" class="check_row" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; background-color: rgb(255, 255, 255); border: 0px; opacity: 0; background-position: initial initial; background-repeat: initial initial;"><ins class="iCheck-helper" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; background-color: rgb(255, 255, 255); border: 0px; opacity: 0; background-position: initial initial; background-repeat: initial initial;"></ins></div></td>
                                <td class="uk-text-center"><img class="md-user-image" src="{{asset('adminassets/assets/img/avatars/avatar_01_tn.png')}}" alt=""></td>
                                <td>{{$user->name}}</td>
                                ...
                                <td class="uk-text-center">
                                    <a href="{{route('adminEdit', ['object' => 'user', 'id' => $user->_id])}}"><i class="md-icon material-icons"></i></a>
                                </td>
                            </tr>
                            @endforeach
