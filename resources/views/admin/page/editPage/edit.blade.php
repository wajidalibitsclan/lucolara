...
@section('main-content')
    <div id="page_content">
        ...
        <div id="page_content_inner">
            ...
            <form method="post" action="{{ route('updatePagina', ['objectId' => $page->id]) }}"
                                        ...
                                        <div class="uk-width-medium-1-1 uk-row-first">
                                            <div class="md-input-wrapper">
                                                ...
                                                <input type="text" class="md-input" name="title"
                                                    value="{{ $page->title }}"><span class="md-input-bar "></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="uk-grid">
                                        <div class="uk-width-medium-1-1 uk-row-first">
                                            <div class="md-input-wrapper">
                                                ...
                                                <textarea id="wysiwyg_ckeditor" class="md-input selecize_init" name="body">{!! $page->body !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
