...
<head>
    ...
    <!-- themes -->
    <link rel="stylesheet" href="{{asset('adminassets/assets/css/themes/themes_combined.min.css')}}" media="all">
            ...
            <li>
                <div class="timeline timeline_small uk-margin-bottom">
                    ...
                    <div class="timeline_item">
                        ...
                        <div class="timeline_content">Deleted post <a href="#"><strong>Amet non deleniti voluptas tenetur.</strong></a></div>
                    </div>
                    <div class="timeline_item">
                    ...
                    <div class="timeline_item">
                        ...
                        <div class="timeline_content">
                            New comment on post <a href="#"><strong>Sit amet a.</strong></a>
                            <div class="timeline_content_addon">
                                <blockquote>
                                    Cumque assumenda quia accusamus suscipit fugiat sapiente et quibusdam iste et in dolor repudiandae.&hellip;
                                </blockquote>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="timeline_content_addon">
                                <ul class="md-list md-list-addon">
                                    <li>
                                        ...
                                        <div class="md-list-content">
                                            <span class="md-list-heading">Kaycee Nolan</span>
                                            <span class="uk-text-small uk-text-muted">Vel sapiente sed fuga facere.</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                ...
                <ul class="md-list md-list-addon chat_users">
                    <li>
                        ...
                        <div class="md-list-content">
                            ...
                            <span class="md-list-heading">Chelsea Harris</span>
                            <span class="uk-text-small uk-text-muted uk-text-truncate">Quas ea aut.</span>
                        </div>
                    </li>
                    <li>
                        <div class="md-list-addon-element">
                        ...
                        <div class="md-list-content">
                            <div class="md-list-action-placeholder"></div>
                            <span class="md-list-heading">Alayna Braun</span>
                            <span class="uk-text-small uk-text-muted uk-text-truncate">Qui ut.</span>
                        </div>
                    </li>
                    <li>
                        <div class="md-list-addon-element">
...
<!-- metrics graphics (charts) -->
<script src="{{asset('adminassets/bower_components/metrics-graphics/dist/metricsgraphics.min.js')}}"></script>
<!-- chartist (charts) -->
<script src="{{asset('adminassets/bower_components/chartist/dist/chartist.min.js')}}"></script>
<!-- maplace (google maps) -->
<script src="http://maps.google.com/maps/api/js"></script>
<script src="{{asset('adminassets/bower_components/maplace-js/dist/maplace.min.js')}}"></script>
<!-- peity (small charts) -->
<script src="{{asset('adminassets/bower_components/peity/jquery.peity.min.js')}}"></script>
<!-- easy-pie-chart (circular statistics) -->
<script src="{{asset('adminassets/bower_components/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js')}}"></script>
<!-- countUp -->
<script src="{{asset('adminassets/bower_components/countUp.js/dist/countUp.min.js')}}"></script>
<!-- handlebars.js -->
<script src="{{asset('adminassets/bower_components/handlebars/handlebars.min.js')}}"></script>
<script src="{{asset('adminassets/assets/js/custom/handlebars_helpers.min.js')}}"></script>
<!-- CLNDR -->
<script src="{{asset('adminassets/bower_components/clndr/clndr.min.js')}}"></script>

<!--  dashbord functions -->
<script src="{{asset('adminassets/assets/js/pages/dashboard.min.js')}}"></script>
