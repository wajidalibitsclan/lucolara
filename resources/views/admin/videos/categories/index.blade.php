                                ...
                                @foreach($categories as $count=>$category)
                                    <tr>
                                        ...
                                        <td class="uk-text-center">
                                            <a href="{{route('admin.video_categories.edit', ['id' => $category->_id])}}"><i class="md-icon material-icons"></i></a>
                                        </td>
                                        <td class="uk-text-center">
                                            <a href="{{route('admin.video_categories.destroy',$category->_id)}}" class="delete_category" data-id="{{$category->_id}}"><i class="md-icon material-icons">&#xE872;</i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                @else
