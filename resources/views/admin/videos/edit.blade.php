                                    ...
                                    <div class="uk-grid">
                                        <div class="uk-width-medium-1-1 uk-row-first">
                                            <div class="md-input-wrapper">
                                                ...
                                                <input type="text" class="md-input" value="{{old('title', $video->title)}}" name="title">
                                    ...
                                    <div class="uk-grid">
                                        <div class="uk-width-medium-1-1 uk-row-first">
                                            <div class="md-input-wrapper">
                                                ...
                                                <input type="number" min="1" maxlength="1" class="md-input" value="{{old('order', $video->order)}}" name="order">
                                                <span class="md-input-bar"></span>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="md-input-wrapper">
                                                ...
                                                <select name="category" id="category" class="md-input">
                                                    @foreach($categories as $key=>$category)
                                                        <option value="{{$key}}" {{ $video->category->id == $key ? "selected":"" }}>{{$category}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="uk-grid">
                                        <div class="uk-width-medium-1-1 uk-row-first">
                                            <div class="md-input-wrapper">
                                                ...
                                                <input type="text" class="md-input" name="link" value="{{old('link', $video->link)}}">
                                                <span class="md-input-bar"></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="uk-grid">
                                        <div class="uk-width-medium-1-1 uk-row-first">
                                            <div class="md-input-wrapper">
                                                ...
                                                <textarea id="wysiwyg_ckeditor" class="md-input selecize_init" name="description">{{old('description', $video->description)}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
