...
@if((isset($post->rassegna_stampa['titolo']) && !empty($post->rassegna_stampa['titolo']))
	|| (isset($post->rassegna_stampa['descrizione']) && !empty($post->rassegna_stampa['descrizione']) || isset($post->rassegna_stampa['file']) && !empty($post->rassegna_stampa['file']))
	|| ((isset($post->rassegna_stampa['descrizione']) && !empty($post->rassegna_stampa['descrizione']) || isset($post->rassegna_stampa['file']) && !empty($post->rassegna_stampa['file'])))
				...
				<div class="row">
					<div class="col-sm-12">
						...
						@if(isset($post->rassegna_stampa['file']) && !empty($post->rassegna_stampa['file']))
							...
							@endforeach
						@endif
						@if(isset($post->rassegna_stampa['descrizione']) && !empty($post->rassegna_stampa['descrizione']) || isset($post->rassegna_stampa['file']) && !empty($post->rassegna_stampa['file']))
						<h4>
							<div style="margin-top: 10px;">
								{!! $post->rassegna_stampa['descrizione'] or ''!!}
							</div>
						</h4>
						@endif
						<br>
