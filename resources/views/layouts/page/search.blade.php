        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h2><span>Risultati di ricerca per: </span>{{$termine or ''}}</h2>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="{{route('search')}}" method="get">
                        ...
                        <input id="ricerca" class="form-control form-control-lg" name="s" type="text" placeholder="Cerca">
                ...
                <div class="col-xs-12">
                    ...
                    <ul>
                        ...
                        <li class="{{$risultato['_source']['type']}}">
                            <div class="titolo"><a href="{{route('dettaglioArticolo', ['object' => $risultato['_source']['type'], 'slug' =>$risultato['_source']['slug']])}}" title="">{{$risultato['_source']['title']}}</a></div>
                            ...
                            <div class="date">
                                @php
                                    ...
                                    $data = explode('-', $data[0]);
                                @endphp
                                <span class="dd">{{$data[2]}}</span>/<span class="mm">{{$data[1]}}</span>/<span class="yy">{{$data[0]}}</span>
                            </div>
                            @endif
                        </li>
                        @endforeach
